...
public class Nouveau extends StigglesNPC {
    private final ArrayList<String> interacted = new ArrayList<>();
    ...
    public ItemStack getMcChicken() {
        ...
        im.setLore(List.of(ChatColor.DARK_GRAY + "Part of the deal"));
        item.setItemMeta(im);
        return item;
    }
    ...
    public ItemStack getSprite() {
        ...
        im.setLore(List.of(ChatColor.DARK_GRAY + "One second of fruitiness guaranteed."));
